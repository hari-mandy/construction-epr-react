...
const LoginForm = () => {
    ...
    const handleunique = async (e, requireMes = '*This Field is required*', checkMailMes = '*Cannot find the user!') => {
    ...
    return (
        <div className="login-form">
            ...
            <form onSubmit={validUser}>
                <InputText containerStyle="input-text-block" labelTitle="Email" inputType="text" placeholder="" onBlurFun={handleunique} name="email" errorMessage={errorMessage.email} inputStyle="input-text" labelStyle="input-label" handleFocus={handleFocus}/>
